...
class HACNNBiLSTM_AR(nn.Module):
    def __init__(self, configs, seq_len=125):
        ...
        if self.apply_wst:
            ...
            # 2 segnali (PPG + ECG Past) -> coeffs * 2
        ...
        # Adattiamo input_dim in base alla presenza della WST
    ...
    def forward(self, x):
        ...
        if self.apply_wst and self.scattering is not None:
            ...
            # Concatenazione dei coefficienti di scattering
        ...
        lstm_out = lstm_out.transpose(1, 2) # (Batch, 256, T_reduced)
